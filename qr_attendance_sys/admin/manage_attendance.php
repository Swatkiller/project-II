...
// Handle form submission to mark attendance manually
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'present') {
        ...
        // Mark all students as a holiday for the current day
...
// Search students by sid or name
...
$query = "SELECT student_details.sid, 
          ...
          ORDER BY student_details.sid DESC LIMIT 5"; // Limit to 5 students
...
<div class="brand-container">
    ...
    <div class="container">
        ...
        <form method="GET" action="manage_attendance.php" style="margin-bottom: 20px; text-align: center;">
            <input type="text" name="search" placeholder="Search by Student ID or Name" value="<?php echo htmlspecialchars($search_keyword); ?>" required>
            <button type="submit" style="background-color: #2980b9; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer;">Search</button>
        </form>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="manage_attendance.php" style="display:inline;">
                                ...
                                <input type="submit" name="action" value="Present" style="background-color: #27ae60; color: white; padding: 5px; border: none; border-radius: 4px;">
                            </form>
                        </td>
                    </tr>
                <?php endwhile; ?>
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <form method="POST" action="manage_attendance.php">
                ...
                <input type="submit" value="Mark All as Holiday" style="background-color: #e74c3c; color: white; padding: 10px; border: none; border-radius: 4px; cursor: pointer;">
            </form>
        </div>

        <!-- Redirect to Post Notice Page -->
        <div style="text-align: center;">
            <a href="post_notice.php" style="background-color: #2980b9; color: white; padding: 10px 20px; border-radius: 4px; text-decoration: none;">Go to Post Notice</a>
        </div>
    </div>
</body>
</html>
